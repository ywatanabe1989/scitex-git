...
# (project=scitex-git, owner=ywatanabe1989, repo=scitex-git,
...
TMPDIR="/tmp/publish-scitex_git-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-git dist/* uploaded to PyPI via manual OIDC trusted publishing"
